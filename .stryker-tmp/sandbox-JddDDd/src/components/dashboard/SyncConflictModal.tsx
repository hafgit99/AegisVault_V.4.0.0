              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div className="text-[10px] opacity-40 mt-2">
                    Son güncelleme: {new Date(conflict.local.updated_at || conflict.local.created_at || 0).toLocaleString()}
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-[10px] opacity-40 mt-2">
                    Son güncelleme: {new Date(conflict.remote.updated_at || conflict.remote.created_at || 0).toLocaleString()}
                  </div>
                </button>
              </div>
            </div>
