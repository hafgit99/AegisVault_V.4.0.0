...
describe("TOTPService", () => {
  ...
  describe("parseOtpauthUri", () => {
    it("should parse a valid otpauth URI with all parameters", () => {
      const uri = "otpauth://totp/ACME:john@example.com?secret=HXDMVJECJJWSRB3HWIZR4IFUGFTMXBOZ&issuer=ACME&algorithm=SHA1&digits=6&period=30";
  ...
  describe("toOtpauthUri", () => {
    ...
    it("should roundtrip through parse", () => {
      const original = createTOTPParams("JBSWY3DPEHPK3PXP", "GitHub", "dev@github.com", "SHA-256", 8, 60);
