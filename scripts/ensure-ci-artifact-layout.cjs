        ...
        checks: [
          {
            id: 'unit',
            required: true,
            artifact: 'vitest-results/vitest-results.json',
            owner: 'desktop',
          },
          {
            id: 'import_export_regression',
            required: true,
            artifact: 'vitest-results/import-export-regression.json',
            owner: 'data',
          },
          {
            id: 'security_regression',
            required: true,
            artifact: 'vitest-results/security-regression.json',
            owner: 'security',
          },
    ...
    contents: `${JSON.stringify(
      {
        ...
        checklist: [
          ...
          { id: 'real_device_install', required: true, owner: 'qa', artifact: 'adb install -r' },
          {
            ...
            required: true,
            owner: 'qa',
            artifact: 'ci-artifacts/android/device-matrix/*',
          },
        ],
      },
      null,
    ...
    contents: `${JSON.stringify(
      {
        ...
        checklist: [
          {
            id: 'controlled_beta_readiness',
            required: true,
            owner: 'android',
            artifact: 'android-aegis-temp/docs/RELEASE_READINESS.md',
          },
          {
            id: 'device_matrix_completed',
            required: true,
            owner: 'qa',
            artifact: 'ci-artifacts/android/device-matrix/device-matrix.json',
          },
          {
            id: 'autofill_browser_validation',
            required: true,
            owner: 'qa',
            artifact: 'manual-device-validation',
          },
          {
            id: 'autofill_native_app_validation',
            required: true,
            owner: 'qa',
            artifact: 'manual-device-validation',
          },
          {
            id: 'passkey_biometric_recovery_validation',
            required: true,
            owner: 'qa',
            artifact: 'manual-device-validation',
          },
          {
            id: 'encoding_polish_ui',
            required: true,
            owner: 'android',
            artifact: 'docs/2026-03-23_ANDROID_UI_ENCODING_POLISH_TR.md',
          },
          {
            id: 'translation_polish',
            required: true,
            owner: 'android',
            artifact: 'docs/2026-03-23_ANDROID_TRANSLATION_POLISH_TR.md',
          },
          {
            id: 'staged_rollout_plan',
            required: true,
            owner: 'release',
            artifact: 'release-rollout-notes',
          },
          {
            id: 'staged_rollout_monitoring',
            required: true,
            owner: 'release',
            artifact: 'docs/2026-03-23_ANDROID_STAGED_ROLLOUT_MONITORING_TR.md',
          },
        ],
      },
      null,
